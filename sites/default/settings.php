...
$conf['tal_episode_related_collection'] = 24293;
$conf['maintenance_theme'] = 'thislife';

$conf['tal_instagram'] = 'https://www.instagram.com/thisamerlife/';

//$conf['tal_sunday_release'] = 'Episode available Sunday evening';

$conf['tal_release_hours'] = 68;

$conf['tal_awards'] = array(
  688 => t('Pulitzer Prize'),
  600 => t('duPont-Columbia Award'),
  581 => t('Peabody Award'),
  562 => t('Peabody & Polk Awards'),
  487 => t('Peabody & duPont-Columbia Awards'),
  465 => t('Peabody Award'),
  355 => t('Peabody, duPont-Columbia & Polk'),
  310 => t('Peabody Award'),
  266 => t('Edward R Murrow Award'),
  570 => t('Edward R Murrow Award'),
  430 => t('Polk Award'),
  322 => t('duPont-Columbia Award'),
);
/*
$conf['tal_classic_episodes'] = array(
  774,
);
$conf['tal_classic_episodes_date'] = '2022-07-03T20:00:00-04:00';
*/
/*
$conf['tal_classic_episodes'] = array(
  165,
...
if (
  ...
  $vars = array_merge($vars, [
    ...
    'cloudflare_secret',
    'cloudflare_workflow_id',
    'cloudflare_worker_url',
  ]);

  //  Load all secrets into configuration variables
  foreach ($vars as $var) {
    $value = $secrets_data[$var] ?: false;
    $conf[$var] = $value;
  }
}
