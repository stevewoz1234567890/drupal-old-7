  ...
  <footer id="footer">
    <div class="footer-inner clearfix">
      ...
      <ul class="links">
        ...
        <?php endif; ?>
        <li class="show serial"><a href="https://serialpodcast.org/"><?php print render($serial) ?></a></li>
        <li class="show s-town"><a href="https://stownpodcast.org/"><?php print render($stown) ?></a></li>
      </ul>
      <div class="copyright">
        ...
        <ul class="share-social">
          ...
          <li class="twitter">
            <a href="<?php print tal_share_url('twitter') ?>" class="shareout ignore twitter">
              ...
              <span class="label"><?php print t('Twitter') ?></span>
            </a>
          </li>
          <li class="mail">
