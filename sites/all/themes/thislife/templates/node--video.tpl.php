...
<article class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if ($page): ?>
    <header<?php print $title_attributes; ?>>
      <div class="container clearfix">
        <div class="meta">
          <div class="field"><?php print l(t('Video'), 'videos') ?></div>
    ...
    <div class="video-wrapper">
      <figure class="video"<?php print $content_attributes; ?>>
    ...
    <?php if (!empty($content['related'])): ?>
      <section class="related">
        <div class="container">
          <h2><span><?php print t('More Videos') ?></span></h2>
  ...
  <?php elseif ($view_mode == 'archive'): ?>
      ...
      <header>
        <div class="meta"><a href="<?php print $node_url ?>"><span class="icon-video"></span></a></div>
