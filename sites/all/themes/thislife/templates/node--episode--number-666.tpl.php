  ...
  <?php if ($page): ?>
    <header<?php print $title_attributes; ?>>
      <div class="video-background">
        <video width="1920" height="1080" playsinline autoplay muted loop src="https://files.thisamericanlife.org/sites/default/files/tal-666.mp4"></video>
      </div>
      <div class="container clearfix">
        <div class="meta">

          <div class="field field-name-field-episode-number field-type-number-integer field-label-hidden">
            <div class="field-items">
              <div class="field-item even">
                <span class="six">6</span>
                <span class="six six-six">6</span>
                <span class="six six-six-six">6</span>
                <div class="pentagram">
                	<div class="star_1"><span></span></div>
                	<div class="star_2"><span></span></div>
                	<div class="star_3"><span></span></div>
                	<div class="star_4"><span></span></div>
                	<div class="star_5"><span></span></div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="content"<?php print $content_attributes; ?>>
      ...
      <?php print render($content['field_notes_lower']) ?>
